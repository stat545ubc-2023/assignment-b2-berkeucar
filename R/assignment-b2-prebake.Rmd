...
#'
#' @example 
#' count_all_missing_by_group(datateachr::steam_games, type, "keep")
#' count_all_missing_by_group(palmerpenguins::penguins, species, "drop")
#' count_all_missing_by_group(palmerpenguins::penguins, island)
#' 
#' @export
