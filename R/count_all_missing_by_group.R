...
#'
#' @examples
#' count_all_missing_by_group(datasets::chickwts, feed, "keep")
#' count_all_missing_by_group(datasets::infert, education, "drop")
#' count_all_missing_by_group(datasets::infert, parity)
